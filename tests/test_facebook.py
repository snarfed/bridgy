...
class FacebookTest(testutil.AppTest):
    ...
    def test_canonicalize_url_username(self):
        ...
        self.assertEqual(
            "https://www.facebook.com/25624/posts/snarfed",
            self.source.canonicalize_url("http://www.facebook.com/25624/posts/snarfed"),
        )

        # if no username, fall through
        self.source.username = None
        self.assertEqual(
            "https://www.facebook.com/212038/posts/444",
    ...
    def test_profile_new_user(self):
        ...
        self.assertEqual(
            "https://scontent-sjc3-1.xx.fbcdn.net/v/t1.0-1/cp0/e15/q65/p74x74/39610935_10104076860151373_4179282966062563328_o.jpg?...",
            fb.picture,
        )
    ...
    def test_post_empty(self):
        ...
        resp = self.get_response(
            f"post?token=towkin&key={key.urlsafe().decode()}",
            data="""\
    <!DOCTYPE html>
    <html><body></body></html>""",
        )
    ...
    def test_post_merge_comments(self):
        ...
        activity_key = Activity(
            id="tag:facebook.com,2013:456", activity_json=json_dumps(existing_activity)
        ).put()
    ...
    def test_likes(self):
        ...
        resp = self.get_response(
            f"likes?id=tag:facebook.com,2013:123&{self.auth}",
