...
class OriginalPostDiscoveryTest(testutil.AppTest):
    ...
    def assert_syndicated_posts(self, *expected):
        got = [
            (r.original, r.syndication)
            for r in SyndicatedPost.query(ancestor=self.source.key)
        ]
    ...
    <html class="h-feed">
      <div class="h-entry">
        ...
        self.assert_syndicated_posts(
            ("http://author/post/final", "https://fa.ke/post/url")
        )
    ...
    <div class="h-entry">
      <a class="u-url" href="http://author/post/permalink3"></a>
        ...
        self.assertEqual(
            (set(["http://author/post/perma✁2"]), set()),
    ...
    <html class="h-feed">
      <div class="h-entry">
        ...
        self.assert_syndicated_posts(
            ("http://author/post/url", None), (None, "https://fa.ke/post/url")
        )
    ...
    def test_existing_syndicated_posts(self):
        ...
        SyndicatedPost(
            parent=self.source.key, original=original_url, syndication=syndication_url
        ).put()
...
<div class="h-feed">
  ...
  <div class="h-entry"><a class="u-url" href="http://author/d"></a>
    <a class="u-syndication" href="http://fa.ke/post/url"></a></div>
        ...
        self.assert_syndicated_posts(
            ("http://author/a", "https://fa.ke/post/url"),
    ...
    <html class="h-feed">
      <div class="h-entry">
        ...
        self.assert_discover([])
        self.assert_syndicated_posts(
            ("http://author/post", None), (None, "https://fa.ke/post/url")
        )
    ...
    <html>
      ...
      <body>
        ...
        self.expect_requests_get("http://author/try_this.html", "nope", status_code=404)
    ...
    """,
        ...
        if raise_exception:
            self.expect_requests_get("http://author/nonexistent.html").AndRaise(
                HTTPError()
            )
        else:
        ...
        self.assert_syndicated_posts(
            ("http://author/nonexistent.html", None), (None, "https://fa.ke/post/url")
        )
    ...
    <html>
      <head>
        ...
        self.expect_requests_head(
            "http://author/updates.rss", content_type="application/xml"
        )
    ...
    <html class="h-feed">
      <article class="h-entry">
        ...
        # remove duplicates)
        self.expect_requests_get(
            "http://author/article-permalink",
            """
    <html class="h-entry">
      <a class="u-url" href="/article-permalink"></a>
      <a class="u-syndication" href="https://fa.ke/article"></a>
    </html>""",
        ).InAnyOrder("permalink")

        self.expect_requests_get(
            "http://author/note-permalink",
            """
    <html class="h-entry">
      <a class="u-url" href="/note-permalink"></a>
    ...
    def test_attachments(self):
        ...
        SyndicatedPost(
            ...
            syndication="https://fa.ke/post/quoted",
        ).put()
    ...
    def test_refetch_hfeed(self):
        ...
        SyndicatedPost(
            parent=self.source.key, original=None, syndication="https://fa.ke/post/url1"
        ).put()

        SyndicatedPost(
            parent=self.source.key,
            original="http://author/permalink2",
            syndication="https://fa.ke/post/url2",
        ).put()
    ...
    <html class="h-entry">
      <a class="u-url" href="http://author/post/permalink"></a>
        ...
        refetch(self.source)
        self.assert_syndicated_posts(
            ("http://author/post/permalink", None), (None, "https://fa.ke/post/url")
        )
    ...
    <a class="u-syndication" href="https://fa.ke/post/url"></a>
        ...
        refetch(self.source)
        self.assert_syndicated_posts(
            ("http://author/permalink", None), (None, "https://fa.ke/post/url")
        )

        refetch(self.source)
        self.assert_syndicated_posts(
            ("http://author/permalink", "https://fa.ke/post/url")
        )
    ...
    <a class="h-entry" href="/post2"></a>
       ...
       <a class="u-syndication" href="https://fa.ke/post/url"></a>
        ...
        self.assert_syndicated_posts(
            ("http://author/post1", "https://fa.ke/post/url"),
    ...
    <a class="u-syndication" href="https://fa.ke/post/url"></a>
        ...
        self.assertEqual(
            "http://author/2014/08/09/this-is-a-stub", new_relations[0].original
        )
    ...
    def test_refetch_blank_syndication(self):
        ...
        blank = SyndicatedPost(
            parent=self.source.key, original="http://author/permalink", syndication=None
        )
        blank.put()
        self.expect_requests_get(
            "http://author/",
  ...
  <div class="h-entry">
    ...
    <html class="h-feed">
      ...
      <div class="h-entry">
        ...
        self.assert_syndicated_posts(
            ("http://author/only-on-frontpage", None),
    ...
    <html class="h-feed">
      ...
      <div class="h-entry">
        ...
        self.assert_syndicated_posts(
            ("http://author/post-with-mistake", None),
            ("http://author/only-on-feed", None),
            (None, "https://fa.ke/post/url"),
        )
    ...
    def test_drop_reserved_hosts(self):
        ...
        self.activity["object"][
            "content"
        ] = "http://localhost http://other/link https://x.test/ http://y.local/path"
        self.assert_discover([], fetch_hfeed=False)
    ...
    <html class="h-feed">
      <div class="h-entry">
        ...
        self.mox.ReplayAll()
        self.source = GitHub(
            id="snarfed", domain_urls=["http://author/"], domains=["author"]
        )
        self.source.put()

        result = refetch(self.source)
        self.assertCountEqual(
            ["https://github.com/post#frag"], result.keys(), result.keys()
        )

        self.activity["object"]["url"] = "https://github.com/post"
        self.assert_discover(["http://author/post"])
        self.assert_syndicated_posts(
            ("http://author/post", "https://github.com/post#frag")
        )
