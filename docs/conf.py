...
exclude_patterns = ['_build', '**/appengine_config.py', '**/tests', '**/test_*.py',
                    '**/mapreduce']
...
# Automatically run sphinx-autogen.
...
# of the sidebar.
html_logo = '../static/bridgy_logo_128.jpg'
